...
my constant Registered is export = 583767;
...
my constant Surface-temperature is export = 287.2;
my constant Surface-pressure is export = 1.01325e+5;
my constant Equatorial-surface-gravity is export = 9.780327;
my constant Escape-velocity is export = 1.1186e+4;
my constant Albedo is export = 0.367;
my constant Albedo is export = 0.306;
...
my constant Astronomical-unit-ua is export = 1.4959787030e+11;
